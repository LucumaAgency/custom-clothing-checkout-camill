...
class WCCDPE_Order_Meta {
    ...
    public function display_admin_meta( $order ) {
        ...
        $display_fields = [
            ...
            '_billing_departamento_contra'      => 'Departamento (Shalom Contra)',
            '_billing_provincia_contra'         => 'Provincia (Shalom Contra)',
            '_billing_distrito_prov_contra'     => 'Distrito (Shalom Contra)',
            '_billing_agencia_shalom_contra'    => 'Agencia Shalom (Contra)',
            '_billing_shalom_sub_tipo_contra'   => 'Modalidad Shalom (Contra)',
    ...
    public function email_meta_fields( $fields, $sent_to_admin, $order ) {
        ...
        $conditional_meta = [
            ...
            'provincia_shalom_prepago'  => [ '_billing_departamento' => 'Departamento', '_billing_provincia' => 'Provincia', '_billing_distrito_prov' => 'Distrito', '_billing_agencia_shalom' => 'Agencia Shalom' ],
            'provincia_shalom_contra'  => [ '_billing_departamento_contra' => 'Departamento', '_billing_provincia_contra' => 'Provincia', '_billing_distrito_prov_contra' => 'Distrito', '_billing_agencia_shalom_contra' => 'Agencia Shalom' ],
